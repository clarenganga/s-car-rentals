    ...
    if($error === 0){
        ...
        if(in_array($img_ex_lc,$allowed_exs)){
            ...
            move_uploaded_file($tmp_name,$img_upload_path);
                ...
                $available="Y";
                $query="INSERT INTO cars(CAR_NAME,FUEL_TYPE,CAPACITY,PRICE,CAR_IMG,AVAILABLE,cname) values('$carname','$ftype',$capacity,$price,'$new_img_name','$available', '$cname')";
            ...
            echo '<script> window.location.href = "companyaddcar.php";</script>';   
        }
    }
    else{
        $em="unknown error occured";
        header("Location: companyaddcar.php?error=$em");
    }
