...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    ...
    <div>
            <h1 class="header">REGISTERED COMPANIES</h1>
            <div>
                <div>
                ...
                <tr  class="active-row">
                    ...
                    <td><button type="submit" class="but" name="approve" onclick="return confirm('Are you sure you want to delete this record?')"><a href="deletecompany.php?id=<?php echo $res['email']?>">DELETE</a></button></td>
                </tr>
               <?php } ?>
                </tbody>
                </table>
